          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(
                  9.75 * fem, 70.65 * fem, 9.75 * fem, 43 * fem),
              width: 394 * fem,
              height: 199 * fem,
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(
                                  0 * fem, 0 * fem, 67.58 * fem, 0.42 * fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
