          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(
                  10.75 * fem, 110.65 * fem, 131 * fem, 51 * fem),
              width: double.infinity,
              height: 231 * fem,
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        0 * fem, 0 * fem, 6.38 * fem, 53.62 * fem),
                    width: 19.87 * fem,
                    height: 15.73 * fem,
                    child: Image.asset(
            ...
            Container(
              // group7LFw (727:67)
              margin:
                  EdgeInsets.fromLTRB(16 * fem, 0 * fem, 26 * fem, 379 * fem),
              padding:
                  EdgeInsets.fromLTRB(21 * fem, 21 * fem, 15 * fem, 9 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin:
                        EdgeInsets.fromLTRB(0 * fem, 0 * fem, 1 * fem, 8 * fem),
                    width: double.infinity,
                    child: Row(
