        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // textXYZ (328:155)
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 71.36 * fem),
              width: 412 * fem,
              height: 410.64 * fem,
              child: Stack(
                children: [
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                16 * fem, 0 * fem, 196 * fem, 11.62 * fem),
                            width: double.infinity,
                            height: 35.38 * fem,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                23 * fem, 0 * fem, 160 * fem, 21.95 * fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                16 * fem, 0 * fem, 152 * fem, 26.76 * fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
            ...
            Container(
              // button31f (328:164)
              margin:
                  EdgeInsets.fromLTRB(113 * fem, 0 * fem, 91 * fem, 0 * fem),
              child: TextButton(
                onPressed: () {},
