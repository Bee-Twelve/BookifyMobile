          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(
                  8.75 * fem, 70.65 * fem, 8.75 * fem, 37 * fem),
              width: double.infinity,
              height: 186 * fem,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    // usermws (99:416)
                    margin: EdgeInsets.fromLTRB(
                        36.25 * fem, 0 * fem, 114.25 * fem, 0 * fem),
                    child: TextButton(
                      onPressed: () {},
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(
                            1.42 * fem, 1.42 * fem, 50 * fem, 0 * fem),
                        width: double.infinity,
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(23 * fem, 0 * fem, 21 * fem, 57 * fem),
              width: double.infinity,
              height: 505 * fem,
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(
                          22 * fem, 22 * fem, 11.22 * fem, 27 * fem),
                      width: 349 * fem,
                      height: 505 * fem,
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(40 * fem),
            ...
            Container(
              // menubardkR (377:634)
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0.07 * fem, 1291 * fem),
              width: 396.83 * fem,
              height: 83 * fem,
              child: Image.asset(
