            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.fromLTRB(
                      3.16 * fem, 7.73 * fem, 2.85 * fem, 7.83 * fem),
                  width: double.infinity,
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 0 * fem, 0.01 * fem, 11.14 * fem),
                            width: double.infinity,
                            height: 41 * fem,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                20.01 * fem, 0 * fem, 18.97 * fem, 11.14 * fem),
                            width: double.infinity,
                            height: 41 * fem,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 0 * fem, 0.55 * fem, 11.14 * fem),
                            width: 388.44 * fem,
                            height: 41 * fem,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                23.17 * fem, 0 * fem, 28.75 * fem, 10.83 * fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                127.84 * fem, 0 * fem, 127.15 * fem, 0 * fem),
                            width: double.infinity,
                            height: 5 * fem,
                            decoration: BoxDecoration(
