                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (username == "user" && password == "user1234") {
                        // Jika username dan password sesuai dengan default
                        ...
                        ScaffoldMessenger.of(context)
                          ...
                          ..showSnackBar(
                            SnackBar(
                              content: const Text(
                                  "Login berhasil dengan default user."),
                            ),
                          );
                        return; // Keluar dari fungsi setelah berhasil login
                      }

                      // Cek kredensial dengan API
                      final response =
