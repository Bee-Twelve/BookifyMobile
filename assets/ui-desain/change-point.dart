        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(39.5*fem, 24*fem, 32.22*fem, 103*fem),
              width: double.infinity,
              decoration: BoxDecoration (
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(264.5*fem, 0*fem, 0*fem, 52.32*fem),
                    child: TextButton(
                      onPressed: () {},
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 20.28*fem, 57*fem),
                    width: 266*fem,
                    height: 30*fem,
                    child: Stack(
                      children: [
                  ...
                  Container(
                    // poinbGh (728:79)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 20.28*fem, 80*fem),
                    child: Text(
                      '0 poin',
                      textAlign: TextAlign.center,
                      style: SafeGoogleFont (
                  ...
                  Container(
                    // borrowHfK (517:151)
                    margin: EdgeInsets.fromLTRB(59.5*fem, 0*fem, 60.37*fem, 22.39*fem),
                    child: TextButton(
                      onPressed: () {},
                      style: TextButton.styleFrom (
                        padding: EdgeInsets.zero,
