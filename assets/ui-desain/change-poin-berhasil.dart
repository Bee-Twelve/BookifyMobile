  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Container(
          // fieldNMs (517:246)
          padding: EdgeInsets.fromLTRB(34*fem, 22*fem, 11.22*fem, 25*fem),
          width: double.infinity,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin: EdgeInsets.fromLTRB(282*fem, 0*fem, 0*fem, 0.22*fem),
                child: TextButton(
                  onPressed: () {},
              ...
              Container(
                ...
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 27.78*fem, 18*fem),
                child: Text(
              ...
              Container(
                // rp0kFw (728:86)
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 21.78*fem, 32*fem),
                child: Text(
                  'Rp0',
                  textAlign: TextAlign.center,
                  style: SafeGoogleFont (
              ...
              Container(
                // borrowGzy (517:250)
                margin: EdgeInsets.fromLTRB(80*fem, 0*fem, 115.78*fem, 0*fem),
                child: TextButton(
                  onPressed: () {},
                  style: TextButton.styleFrom (
                    padding: EdgeInsets.zero,
